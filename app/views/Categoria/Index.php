<script src="<?php echo URL_BASE ?>assets/js/CadCategoria.js"></script>
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:;" onclick="buscarCategoria(<?php echo $c->id_categoria ?>)"
                                    class="">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Cadastrar Categoria</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?php echo URL_BASE . 'categoria/salvar' ?>" id="frmCategoria" name="frmCategoria"
                    method="post">
                    <div class="row">
                        <div class="col-sm">
                            <h6>Categoria</h6>
                            <input type="hidden" name="id_categoria" id="id_categoria" value="">
                            <input type="text" class="form-control" name="categoria" id="categoria" value="" required>
                        </div>
                    </div>
            </div>
